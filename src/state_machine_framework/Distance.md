...
[ftc/electronvolts/util/units/Distance.java](https://github.com/FTC7393/state-machine-framework/blob/master/src/ftc/electronvolts/util/units/Distance.java)
```java
