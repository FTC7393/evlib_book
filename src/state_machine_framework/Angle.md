**Angle** | [Distance](Distance.md) | [Time](Time.md) | [Velocity](Velocity.md) | [AngularVelocity](AngularVelocity.md)
...
[ftc/electronvolts/util/units/Angle.java](https://github.com/FTC7393/state-machine-framework/blob/master/src/ftc/electronvolts/util/units/Angle.java)
```java
