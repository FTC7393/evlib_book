[Angle](Angle.md) | [Distance](Distance.md) | **Time** | [Velocity](Velocity.md) | [AngularVelocity](AngularVelocity.md)
...
[ftc/electronvolts/util/units/Time.java](https://github.com/FTC7393/state-machine-framework/blob/master/src/ftc/electronvolts/util/units/Time.java)
```java
