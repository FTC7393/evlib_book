AbstractOptionsOp extends [[AbstractOp]]. You can use it to take input from the gamepad and store settings for autonomous in a file on the robot phone. It uses [OptionsFile](https://github.com/FTC7393/state-machine-framework/wiki/OptionsFile) from the state-machine-framework.
